...
class ClassListsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create class_list" do
    assert_difference('ClassList.count') do
      post class_lists_url, params: { class_list: { c_account: @class_list.c_account, c_name: @class_list.c_name } }
    end
  ...
  test "should update class_list" do
    patch class_list_url(@class_list), params: { class_list: { c_account: @class_list.c_account, c_name: @class_list.c_name } }
